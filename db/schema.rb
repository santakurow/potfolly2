...
ActiveRecord::Schema.define(version: 2020_07_07_032244) do
  ...
  create_table "portfolios", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.string "title"
    t.string "url"
    t.text "desc"
    t.bigint "user_id"
